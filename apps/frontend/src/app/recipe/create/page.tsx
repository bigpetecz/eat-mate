...
const CreateRecipePage: FC = () => {
  // Optionally, you can check auth here for SSR/SEO, but for client-side:
  // const { user } = useAuthStore();
  // if (!user) return null; // fallback if needed
  ...
  return (
    <PrivatePage>
      <div className="bg-muted min-h-[calc(100vh-8rem)] pt-8">
