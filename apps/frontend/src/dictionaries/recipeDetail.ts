...
export const recipeDetailDictionary = {
  en: {
    ...
    backToMyRecipes: 'Back to My Recipes',
  ...
  cs: {
    ...
    mealType: 'Typ jídla',
    noImage: 'Bez obrázku',
    recipeOrigin: 'Původ receptu',
    viewOriginalSource: 'Zobrazit původní zdroj',
    ...
    edit: 'Upravit',
    backToDiscover: 'Zpět na Objevuj',
    backToFavorites: 'Zpět na Oblíbené',
    backToMyRecipes: 'Zpět na Moje recepty',
