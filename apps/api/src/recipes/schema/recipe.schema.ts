...
import { AIInfo, AIInfoSchema } from './recipe-ai-info.schema';
import { Rating, RatingSchema } from './recipe-rating.schema';
...
// Configure JSON and Object transforms to map _id → id and remove __v
